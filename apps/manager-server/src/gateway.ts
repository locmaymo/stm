...
function loginPage(text: GatewayText, message: string | null, blocked: string | null, next: string, formToken: string, passcode: boolean, nonce: string, logo: boolean): string {
   ...
   *
   * The radius is a fixed share of the plate - a little over a fifth of its
   * width, which is the proportion a home screen uses. It was half again as
   * round before, and at that radius the plate reads as a button or a coin
   * rather than as the icon of an app somebody is about to sign in to.
   *
