  ...
  en: {
    ...
    what: {
      ...
      cards: [
        ...
        { icon: 'monitor', title: 'Use it here', body: 'Open SillyTavern inside the panel, already signed in, with a window bar for backing up, reading the logs and going full screen — or in a tab of its own with the same tools.' },
        ...
        { icon: 'archive', title: 'Back up', body: 'Scheduled ZIP archives and restore points you name yourself, compatible with SillyTavern’s own exports, plus previewed restores and a safety snapshot before anything is replaced.' },
        ...
        { icon: 'server', title: 'Bring a machine back', body: 'The bucket also keeps how the manager was set up. Sign in with the same Cloudflare account on a new machine and the data, the SillyTavern release and the settings come back.' },
        { icon: 'box', title: 'Saver mode', body: 'For machines with little room for files: no archives on the machine, the cloud holds the recovery points, and a restore is written as it arrives.' },
  ...
  vi: {
    ...
    what: {
      ...
      cards: [
        ...
        { icon: 'monitor', title: 'Dùng ngay tại đây', body: 'Mở SillyTavern ngay bên trong bảng điều khiển, đã đăng nhập sẵn, có thanh cửa sổ để sao lưu, xem nhật ký và phóng toàn màn hình — hoặc mở trong tab riêng với cùng bộ tiện ích.' },
        ...
        { icon: 'archive', title: 'Sao lưu', body: 'Tệp ZIP theo lịch và các điểm khôi phục do bạn tự đặt tên, tương thích với bản xuất của chính SillyTavern, kèm xem trước khi phục hồi và một bản chụp an toàn trước khi có gì bị ghi đè.' },
        ...
        { icon: 'server', title: 'Dựng lại cả máy', body: 'Bucket còn giữ cả cách trình quản lý được thiết lập. Đăng nhập cùng tài khoản Cloudflare trên máy mới là dữ liệu, bản SillyTavern và các thiết lập quay về.' },
        { icon: 'box', title: 'Chế độ tiết kiệm', body: 'Cho máy ít chỗ chứa tệp: không giữ tệp lưu trên máy, cloud giữ các điểm phục hồi, và bản phục hồi được ghi thẳng khi dữ liệu tới.' },
